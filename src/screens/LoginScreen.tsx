...
// 1. Interface alinhada estritamente com o ClienteInDto
...
export default function HomeScreen() {
  ...
  // 2. Estado inicial sem o lixo do endereço
  ...
  const handleRegister = async () => {
    // 3. Validação apenas dos campos que o backend realmente pede
    if (
    ...
    // 4. Mapeamento blindado. O Jackson do Spring Boot vai aceitar isto sem reclamar.
          ...
          >
            ...
            <View style={styles.form}>
              {authMode === "login" ? (
                ...
                <>
                  {/* Inputs de Cadastro refatorados */}
                  <View style={styles.inputGroup}>
                  ...
                  {/* Celular voltou a existir visualmente */}
                  <View style={styles.inputGroup}>
                  ...
                  <View style={styles.inputGroup}>
                    ...
                    <TextInput
                      ...
                      placeholder="M ou F (Veja a nota sobre o Enum)"
